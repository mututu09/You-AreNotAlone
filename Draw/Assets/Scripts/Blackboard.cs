...
public class Blackboard : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        //获取画板尺寸
        var l_originTexture = GetComponent<MeshRenderer>().material.mainTexture as Texture2D;//使用as进行进行类型转换
        //Debug.Log("主材质：" + GetComponent<MeshRenderer>().material.mainTexture.name);
